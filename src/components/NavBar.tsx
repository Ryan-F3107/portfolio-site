...
export const NavBar = () => {
    ...
    return () => window.removeEventListener("scroll", handleScroll); /* remove event Listener once done to avoid memory leaks */
    }, [])
    return (
    <nav 
        className={cn(
            ...
            <div className="container flex items-center justify-between">
                <a className="text-lg font-bold text-primary flex items-center">
                    <span className="relative z-10">
                        <span className="text-glow text-foreground">RF</span> Portfolio
                    </span>
                </a>
                {/* desktop version */}
                ...
                <button 
                    ...
                    className="md:hidden p-5 text-foreground z-50"
